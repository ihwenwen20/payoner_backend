...
const getAllUsers = async (req, page, limit, search) => {
	const query = {
		$or: [
	...
	const usersData = await paginateData(Users, query, page, limit);
	...
	await Users.populate(usersData.data, populateOptions);
